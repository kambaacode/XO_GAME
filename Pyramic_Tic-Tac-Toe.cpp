...
//   cout << endl;
    ...
    cout << "         "<<'|';
    cout << "(" << 1 << "," << 1 << ")";
      cout << setw(2) << board [1][1] << " |";
       cout << "(" << 1 << "," << 2 << ")";
      cout << setw(2) << board [1][2] << " |";
    cout << "(" << 1 << "," << 3<< ")";
      cout << setw(2) << board [1][3] << " |";
      cout << "\n-----------------------------\n";
      cout <<"\n| ";
    cout << "(" << 2 << "," << 0 << ")";
      cout << setw(2) << board [2][0] << " |";
    cout << "(" << 2 << "," << 1 << ")";
      cout << setw(2) << board [2][1] << " |";
    cout << "(" << 2 << "," << 2 << ")";
      cout << setw(2) << board [2][2] << " |";
    cout << "(" << 2 << "," << 3 << ")";
      cout << setw(2) << board [2][3] << " |";
    cout << "(" << 2 << "," << 4 << ")";
      cout << setw(2) << board [2][4] << " |";
      cout << "\n-----------------------------\n";
}
...
bool X_O_Board::is_winner() {
   ...
   if(board[0][2] != 0 && (board[0][2] == board[1][3] && board[0][2] == board[2][4])){
       return true;
   }   if(board[1][3] != 0 && (board[1][3] == board[1][2] && board[1][3] == board[1][1])){
       return true;
   }   if(board[2][4] != 0 && (board[2][4] == board[2][3] && board[2][4] == board[2][2])){
       return true;
   }
